...
public class RegisterUserActions {
	...
	@Step
	public void requestApiGetUserDetailsMethod(int userid) throws Exception {
		response = SerenityRest.given().contentType("application/json").pathParam("userid", userid).when()
				.get(Constants.GETRUSER_ENDPOINT);
	}
	@Step
